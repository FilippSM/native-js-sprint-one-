...
test('Object inside an object -> array -> object ->  object', () => {
    ...
    let man6FullCopy = {...man6, mother: {...man6.mother, parents: man6.mother.parents.map(el => ({...el, favoriteDish: {...el.favoriteDish}}))}}
    man6FullCopy.mother.parents[0].age = 55;
    
    expect( man6.mother.parents[0].age).toBe(80)
    expect( man6FullCopy.mother.parents[0].age).toBe(55)
})
...
test('Array of objects inside an object -> object -> array -> object ->  object', () => {
    ...
    let man7FullCopy = {...man7, mother: {...man7.mother, parents: man7.mother.parents.map(el => ({...el, favoriteDish: {...el.favoriteDish, ingredients: el.favoriteDish.ingredients.map(el => ({...el}))}}))}}
    man7FullCopy.mother.parents[0].favoriteDish.ingredients[0].title = "sup";
    
    expect( man7.mother.parents[0].favoriteDish.ingredients[0].title).toBe("beet")
    expect( man7FullCopy.mother.parents[0].favoriteDish.ingredients[0].title).toBe("sup")
})